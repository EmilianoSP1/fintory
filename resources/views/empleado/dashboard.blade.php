...
@section('contenido')
  {{-- HEADER PERSONALIZADO PARA EMPLEADO + MODO OSCURO + MENÚ LATERAL --}}
  <div 
  ...
  >
    <div class="flex items-center h-14 px-4 md:px-6">
      ...
      {{-- Botón modo oscuro CLARO/OSCURO --}}
      <div 
        x-data="{
...
>
  ...
  <div x-show="origenCredito==='Otros'" x-cloak>
    ...
    {{-- Input SOLO si selecciona "escribir" --}}
    <input
...
{{-- Proveedor SOLO si Origen=Proveedor --}}
<div x-show="origenCredito==='Proveedor'" x-cloak>
  ...
  {{-- Input SOLO si selecciona "escribe proveedor" --}}
  <input
  ...
  >
  {{-- Campo oculto que SIEMPRE manda el proveedor correcto --}}
...
<div class="max-w-7xl mx-auto bg-white shadow rounded-lg overflow-auto">
      ...
      @forelse($filas as $fila)
        <tr class="hover:bg-gray-50">
          ...
          @if($fila['ingreso'])
            ...
            {{-- Otros: monto + descripción truncada/expandible --}}
